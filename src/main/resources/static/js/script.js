...
function updateUserNav() {
    ...
    if (user && user.avatar) {
        ...
        // Chưa login - hiển thị login/register buttons
        authButtons.innerHTML = `
...
// Logout function
function logout() {
    fetch(`${AUTH_API_URL}/logout`, { method: 'POST' })
        .then(res => res.json())
        .then(() => {
...
document.addEventListener("DOMContentLoaded", () => {
    handleSearchBox();
    updateCartCount();
    updateUserNav(); // Update navbar theo user login status
